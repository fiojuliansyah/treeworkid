                ...
                <div class="card mb-5 mb-xl-10">
                    <div class="card-body pt-9 pb-0">
                        ...
                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('web-account') }}">Account</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" href="{{ route('web-profile') }}">Profile</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('web-document') }}">Documents</a>
                            </li>
                        </ul>
                    </div>
                </div>
