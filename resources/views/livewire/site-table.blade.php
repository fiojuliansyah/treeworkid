        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
            ...
            <tbody class="text-gray-600 fw-semibold">
                ...
                <tr>
                    ...
                    <td>{{ $site->name }}</td>
                    <td class="text-end">
                        <a href="#" class="btn btn-light btn-active-light-primary btn-flex btn-center btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" wire:ignore.self>Actions 
                        <i class="ki-outline ki-down fs-5 ms-1"></i></a>
                        <!--begin::Menu-->
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                            <div class="menu-item px-3">
                                <a href="#" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#modal-edit{{ $site->id }}" wire:ignore.self>Edit</a>
                            </div>
                            <div class="menu-item px-3">
                                <a href="#" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#modal-delete{{ $site->id }}" wire:ignore.self>Hapus</a>
                            </div>
                            <!--end::Menu item-->
                        </div>
                        <!--end::Menu-->
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body px-5 my-7">
                                ...
                                <form class="form" action="{{ route('sites.update', ['site' => $site->id]) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="text-center pt-10">
                                        <button type="submit" class="btn btn-primary" wire:ignore.self>
                                            <span class="indicator-label">Submit</span>
                                            <span class="indicator-progress">Please wait... 
                                            <span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                                        </button>
