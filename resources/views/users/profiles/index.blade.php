            ...
            <div id="kt_app_content_container" class="app-container container-fluid">
                <div class="card mb-5 mb-xl-10">
                    <div class="card-body pt-9 pb-0">
                        ...
                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                            <li class="nav-item">
                                <a class="nav-link active" href="{{ route('user-account', ['id' => encrypt($user->id)]) }}">Account</a>
                            </li>
                            <li class="nav-item">
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div id="kt_account_settings_profile_details" class="collapse show">
                        <form class="form" action="{{ route('user-update-account',$user->id) }}" method="POST">
                            @method('PUT')
                            @csrf
                            <div class="card-body border-top p-9">
                                ...
                                <div class="row mb-6">
                                    <label class="col-lg-4 col-form-label required fw-semibold fs-6">Atasan</label>
                                    <div class="col-lg-8 fv-row">
                                        <select class="form-select form-control-lg form-control-solid" data-kt-select2="true" name="leader_id" data-placeholder="Select an option">
                                            <option>Pilih</option>
                                            @foreach($users as $item)
                                            <option value="{{ $item->id }}" {{ $user->leader_id == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
